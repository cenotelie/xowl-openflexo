...
/**
 * Represents the configuration of a xOWL model slot
 *
 * @author Laurent Wouters
 */
public class XOWLModelSlotInstanceConfiguration extends TypeAwareModelSlotInstanceConfiguration<XOWLOntology, XOWLOntology, XOWLModelSlot> {
    /**
     ...
     */
    protected XOWLModelSlotInstanceConfiguration(XOWLModelSlot modelSlot, CreateVirtualModelInstance action) {
